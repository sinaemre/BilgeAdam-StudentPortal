            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(6028),
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(5220),
                            Name = ".NET",
                            Status = 1,
                            TotalHour = 320
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(5251),
                            Name = "Java",
                            Status = 1,
                            TotalHour = 250
                        });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.CustomerManager", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(5613),
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(6199),
                        ...
                        new
                        {
                            ...
                            ClassroomId = new Guid("4a7cbc57-034e-4511-8e42-ddc5ba586438"),
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(6210),
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 16, 14, 41, 27, 76, DateTimeKind.Local).AddTicks(5846),
